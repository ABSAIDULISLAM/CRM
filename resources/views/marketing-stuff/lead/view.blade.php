            ...
            <div class="col-xl-9">
                <div class="contact-tab-wrap d-flex justify-content-between">
                    <ul class="contact-nav nav">
                        ...
                        <li>
                            <a href="{{route('Marketing.lead.edit',['id' => Crypt::encrypt($data->id)]) }}" class="active"><i
                                    class="las la-user-clock"></i>Edit Lead</a>
                        </li>
                        <li>
                            <a href="{{route('Marketing.lead.convert.client',['id' => Crypt::encrypt($data->id)]) }}" onclick="return confirm('Are you sure to convert this Lead into Client ??')" class="active"><i
