            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8 float-end ms-auto">
                    <div class="d-flex title-head">
                        ...
                        <a href="{{route('Marketing.lead.create')}}" class="btn add-btn" ><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar d-flex align-items-center">
                                        ...
                                        <a class="text-success text-bold" href="{{route('Marketing.lead.view',['id' => Crypt::encrypt($item->id)]) }}" class="profile-split">{{$item->company_name}}</a>
                                    </h2>
                                </td>
                                <td>{{$item->name}}</td>
