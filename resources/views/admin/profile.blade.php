                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            <h3 class="user-name m-t-0 mb-0">John Doe
                                            </h3>
                                            <h6 class="text-muted">UI/UX Design Team
                                            </h6>
                                    ...
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            <li>
                                                ...
                                                <div class="text"><a href="#">9876543210</a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="title">Email:</div>
                                                <div class="text"><a href="#"><span class="__cf_email__"
                                                            data-cfemail="aac0c5c2c4cec5cfeacfd2cbc7dac6cf84c9c5c7">[email&#160;protected]</span></a>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <div class="experience-content">
                                                <div class="timeline-content">
                                                    <a href="#/" class="name">International
                                                        College of Arts and
                                                        Science (UG)</a>
                                                    <div>Bsc Computer Science
                                                    </div>
                                                    <span class="time">2000 -
                                                        2003</span>
                                                </div>
                                            </div>
                                        </li>
                                ...
                                <div class="experience-box">
                                    <ul class="experience-list">
                                        <li>
                                            ...
                                            <div class="experience-content">
                                                <div class="timeline-content">
                                                    <a href="#/" class="name">Web
                                                        Designer at Zen
                                                        Corporation</a>
                                                    <span class="time">Jan 2013 -
                                                        Present (5 years 2
                                                        months)</span>
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="project-title"><a href="project-view.html">Video
                                        Calling App</a></h4>
                                <small class="block text-ellipsis m-b-15">
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="input-block mb-3">
                                        <label class="col-form-label">Employee PF
                                            rate</label>
                                        <select class="select">
                                            <option>Select PF contribution</option>
                                            <option>Yes</option>
                                ...
                                <div class="col-sm-4">
                                    <div class="input-block mb-3">
                                        <label class="col-form-label">Additional rate
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="input-block mb-3">
                                        <label class="col-form-label">ESI
                                            contribution</label>
                                        <select class="select">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="input-block mb-3">
                                        <label class="col-form-label">Employee ESI
                                            rate</label>
                                        <select class="select">
                                            <option>Select ESI contribution</option>
                                            <option>Yes</option>
                                ...
                                <td class="table-namesplit">
                                    ...
                                    <a href="javascript:void(0);" class="table-name">
                                        ...
                                        <p><span class="__cf_email__"
                                                data-cfemail="f993969197b99d8b9c98949e8c808a8d9c9a91d79a9694">[email&#160;protected]</span>
                                        </p>
                                    </a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="table-namesplit">
                                    ...
                                    <a href="javascript:void(0);" class="table-name">
                                        ...
                                        <p><span class="__cf_email__"
                                                data-cfemail="d4a2bdbabbb0faa794b0a6b1b5b9b3a1ada7a0b1b7bcfab7bbb9">[email&#160;protected]</span>
                                        </p>
                                    </a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="table-namesplit">
                                    ...
                                    <a href="javascript:void(0);" class="table-name">
                                        <span>Harika </span>
                                        <p><span class="__cf_email__"
                                                data-cfemail="bfd7decdd6d4de91c9ffdbcddaded2d8cac6cccbdadcd791dcd0d2">[email&#160;protected]</span>
                                        </p>
                                    </a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="table-namesplit">
                                    ...
                                    <a href="assets-details.html" class="table-name">
                                        <span>Mythili</span>
                                        <p><span class="__cf_email__"
                                                data-cfemail="fc91858894959095bc988e999d919b89858f88999f94d29f9391">[email&#160;protected]</span>
                                        </p>
                                    </a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="table-namesplit">
                                    ...
                                    <a href="assets-details.html" class="table-name">
                                        <span>John Paul Raj</span>
                                        <p><span class="__cf_email__"
                                                data-cfemail="b0dadfd8def0d4c2d5d1ddd7c5c9c3c4d5d3d89ed3dfdd">[email&#160;protected]</span>
                                        </p>
                                    </a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="table-namesplit">
                                    ...
                                    <a href="javascript:void(0);" class="table-name">
                                        <span>Vinod Selvaraj</span>
                                        <p><span class="__cf_email__"
                                                data-cfemail="87f1eee9e8e3a9f4c7e3f5e2e6eae0f2fef4f3e2e4efa9e4e8ea">[email&#160;protected]</span>
                                        </p>
                                    </a>
                                </td>
                                <td>
                ...
                <div class="modal-body">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Passport Expiry
                                        Date</label>
                                    <div class="cal-icon">
                                        <input class="form-control datetimepicker" type="text">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Employment of
                                        spouse</label>
                                    <input class="form-control" type="text">
                                </div>
                            </div>
                        ...
                        <div class="form-scroll">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="add-more">
                                        <a href="javascript:void(0);"><i class="fa-solid fa-plus-circle"></i>
                                            Add More</a>
                                    </div>
                                </div>
                            </div>
