...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar d-flex align-items-center">
                                            ...
                                            <a href="#" class="profile-split">{{ $item->name }}</a>
                                        </h2>
                                    </td>
                                    <td> {{ $item->slug }}</td>
                                    <td>
                                        <a href="{{ route('Category.status', Crypt::encrypt($item->id)) }}"
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item"
                                                    href="{{ route('Category.edit', Crypt::encrypt($item->id)) }}"><i
                                            ...
                                            <div class="modal-body">
                                                <div class="success-message text-center">
                                                    ...
                                                    <div class="col-lg-12 text-center form-wizard-button">
                                                        ...
                                                        <a href="{{ route('Category.delete', Crypt::encrypt($item->id)) }}"
    ...
    @includeIf('admin.category.partial.add_category')
