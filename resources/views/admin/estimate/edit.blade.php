...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <form method="POST" name="estimateEdit" action="{{route('Estimate.update')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12 my-2">
                        <div class="input-block mb-3">
                            ...
                            <div class="user-icon">
                                ...
                                <select name="lead_id" id="leadId" required class="form-control @error('lead_id') is-invalid border border-danger @enderror" required>
                                    <option disabled>Select Lead</option>
                                    @forelse ($leads as $item)
                                        <option value="{{$item->id}}"@if ($item->id == $data->lead_id) selected @endif>{{$item->company_name}}</option>
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="input-block mb-3">
                            ...
                            <div class="cal-icn">
                                <input type="date" name="estimate_date" value="{{$data->estimate_date}}" required
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="input-block mb-3">
                            ...
                            <div class="cal-ico">
                                <input type="date" name="expiry_date" value="{{$data->expiry_date}}" required
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-hover table-white" id="addSpecification">
                                <thead>
                                    <div class="p-2" style="background-color: rgba(252, 162, 167, 0.2)">Product Estimating Details </div>
                                    <tr>
